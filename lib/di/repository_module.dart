...
void repositoryModule(GetIt locator){
  ...
  locator.registerLazySingleton<LaunchListRepository>(() =>
      provideLaunchListRepository(locator<AppPreferences>(), locator<ApiService>()));
}

LaunchListRepository provideLaunchListRepository(AppPreferences preferences, ApiService apiService) {
